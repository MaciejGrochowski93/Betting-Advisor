...
<body>
    ...
    <main>
            <form action = "calculateProbResult">
                <h4>In this place you can calculate probability of success implied by bookmakers odds.</h4>
                ...
                <input type = "number" class = "numberProb" name = "userInputOdds" min = "1.01" max = "1000" step = "0.01" required><br>
